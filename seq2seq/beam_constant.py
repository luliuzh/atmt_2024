...
class BeamSearch(object):
    ...
    def __init__(self, beam_size, max_len, pad):
        ...
        self.completed = []  # Store all completed hypotheses
    ...
    def add(self, score, node):
        ...
        if node.sequence[-1] == self.pad or node.length >= self.max_len:
            # Mark as completed if EOS is reached or max length is exceeded
    ...
    def all_completed(self):
        ...
        return len(self.completed) == self.beam_size
